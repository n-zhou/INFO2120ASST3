...
public class DatabaseBackend {
    ...
    ArrayList<HashMap<String, Object>> findJourneys(String fromPlace, String toPlace, Date journeyDate) throws OlympicsDBException, SQLException {
        ...
        while(rset.next()){
            ...
            journey.put("origin_name", rset.getInt("P1.place_name"));
            journey.put("dest_name", rset.getInt("P2.place_name"));
    ...
    ArrayList<HashMap<String,Object>> getMemberBookings(String memberID) throws Exception {
        ...
        try{
        	...
        	while(rset.next()){
                ...
                booking.put("origin_name", rset.getInt("P1.place_name"));
                booking.put("dest_name", rset.getInt("P2.place_name"));
    ...
    public HashMap<String,Object> getJourneyDetails(int journey_id) throws OlympicsDBException {
        ...
        details.put("origin_name", rset.getInt("P1.place_name"));
        details.put("dest_name", rset.getInt("P2.place_name"));
